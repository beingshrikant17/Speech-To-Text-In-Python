...
engine = pyttsx3.init("sapi5")  # Selecting Engine
voices = engine.getProperty("voices")  # getting property
engine.setProperty("rate", 150)  # Setting up the property
engine.setProperty("voice", "en-in")  # Setting up default language as a Indian English
engine.setProperty("voice", voices[1].id)  # initializing the voice in a men
...
class SpeechRecognitionApp(tk.Tk):
    def __init__(self):
        ...
        self.scr = scrolledtext.ScrolledText(self, width=80, height=14)
        ...
        self.speak_button = RoundedButton1(
            self.button_frame,
            text="Speak",
        ...
        self.TextToVoice_button = RoundedButton3(
            self.button_frame,
            text="Text to Voice",
            command=self.speak,
            bg="#80669d",
        ...
        self.copy_button = RoundedButton2(
            self.button_frame,
            text="Copy Text",
        ...
        self.Change_Voice_button = RoundedButton4(
            self.button_frame,
            text="Clear Scrollbar",
            command=self.delete_scrollbar,
            bg="gray",
            fg="black",
            font=("Helvetica", 16),
            width=13,
        ...
        self.exit_button = RoundedButton5(
            self.button_frame,
            text="Exit",
    ...
    # the method to be called when user will click the Exit  Button
    def exit_app(self):
